...
class PerformancePrinter(Printer):
    ...
    def print_header(self, functions: Sequence[Callable], arguments: Sequence[Any]) -> int:
    ...
    def __print_function_descriptions(self, functions: Sequence[Callable]) -> int:
    ...
    @staticmethod
    def __print_argument_header(arguments: Sequence[Any]) -> int:
    ...
    def print_measurements_row(self, measurements: Sequence[Measurement], row_length: int) -> None:
